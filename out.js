...
var Module = typeof VideoWriter != 'undefined' ? VideoWriter : {};
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('out.worker.js');
  ...
  function ___syscall_lstat64(path, buf) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(7, 1, path, buf);
  ...
  function ___syscall_openat(dirfd, path, flags, varargs) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(9, 1, dirfd, path, flags, varargs);
  ...
  function ___syscall_renameat(olddirfd, oldpath, newdirfd, newpath) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(10, 1, olddirfd, oldpath, newdirfd, newpath);
  ...
  function ___syscall_unlinkat(dirfd, path, flags) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(13, 1, dirfd, path, flags);
  ...
  function _environ_get(__environ, environ_buf) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(14, 1, __environ, environ_buf);
  ...
  function _environ_sizes_get(penviron_count, penviron_buf_size) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(15, 1, penviron_count, penviron_buf_size);
  ...
  function _fd_close(fd) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(16, 1, fd);
  ...
  function _fd_read(fd, iov, iovcnt, pnum) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(17, 1, fd, iov, iovcnt, pnum);
  ...
  function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(18, 1, fd, offset_low, offset_high, whence, newOffset);
...
var proxiedFunctionTable = [null,_proc_exit,exitOnMainThread,pthreadCreateProxied,___syscall_fcntl64,___syscall_fstat64,___syscall_ioctl,___syscall_lstat64,___syscall_newfstatat,___syscall_openat,___syscall_renameat,___syscall_rmdir,___syscall_stat64,___syscall_unlinkat,_environ_get,_environ_sizes_get,_fd_close,_fd_read,_fd_seek,_fd_write];
...
/** @type {function(...*):?} */
var _initWriter = Module["_initWriter"] = function() {
  return (_initWriter = Module["_initWriter"] = Module["asm"]["initWriter"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _finalize = Module["_finalize"] = function() {
  return (_finalize = Module["_finalize"] = Module["asm"]["finalize"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _appendImage = Module["_appendImage"] = function() {
  return (_appendImage = Module["_appendImage"] = Module["asm"]["appendImage"]).apply(null, arguments);
};
...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return VideoWriter; });
